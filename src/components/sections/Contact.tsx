...
export default function Contact() {
  ...
  const inputClass =
    "w-full px-4 py-3 bg-[#111111] border border-[#1f1f1f] rounded text-sm text-[#f5f5f5] placeholder-[#3a3a3a] focus:outline-none focus:border-[#f59e0b] focus:ring-1 focus:ring-[#f59e0b] transition-colors duration-200";
      ...
      <div className="max-w-6xl mx-auto px-6">
        ...
        <div className="grid md:grid-cols-5 gap-12">
            ...
            <div className="space-y-6">
              <div>
                ...
                <div className="space-y-3">
                  ...
                  >
                    <span className="w-8 h-8 rounded bg-[#111111] border border-[#1f1f1f] flex items-center justify-center flex-shrink-0 group-hover:border-[#2a2a2a] transition-colors">
                      <svg className="w-3.5 h-3.5 text-[#6b6b6b]" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.75} aria-hidden="true">
                  ...
                  >
                    <span className="w-8 h-8 rounded bg-[#111111] border border-[#1f1f1f] flex items-center justify-center flex-shrink-0 group-hover:border-[#2a2a2a] transition-colors">
                      <svg className="w-3.5 h-3.5 text-[#6b6b6b]" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
              ...
              <div className="p-4 bg-[#111111] border border-[#1f1f1f] rounded-lg">
          ...
          <FadeIn delay={0.2} className="md:col-span-3">
            {formState === "success" ? (
              <div className="p-8 bg-[#111111] border border-[#1f1f1f] rounded-lg text-center">
                ...
                <p className="text-[#f5f5f5] font-medium">Message sent</p>
